...
def setup_model_and_optimizer(
    ...
    learning_rate: float, 
    epochs: int
) -> Tuple[MotionLanguageAligner, nn.Module, optim.Optimizer, optim.lr_scheduler.LRScheduler]:
    """
...
def train_loop(
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if (epoch + 1) % 20 == 0:
            ...
            print(f"Epoch [{epoch+1}/{epochs}] | Loss: {avg_loss:.4f} | Acc: {accuracy:.2%} | LR: {current_lr:.6f}")
